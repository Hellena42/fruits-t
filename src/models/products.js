exports.products = [
  ...
  {
    _id: '2',
    name: 'Grapes Red Globe - Local',
    price: 123,
    image: ['/img/products/grape.jpg', '/img/products/grape2.jpg', '/img/products/grape3.jpg', '/img/products/grape4.jpg'],
  ...
  {
    _id: '3',
    name: 'Peaches Yummy Yummy',
    price: 568,
    image: ['/img/products/peaches.jpg', '/img/products/peaches2.jpg', '/img/products/peaches3.jpg', '/img/products/peaches4.jpg'],
    description: 'Peach, (Prunus persica), fruit tree of the rose family (Rosaceae), grown throughout the warmer temperate regions of both the Northern and Southern hemispheres. Peaches are widely eaten fresh and are also baked in pies and cobblers; canned peaches are a staple commodity in many regions. Yellow-fleshed varieties are especially rich in vitamin A.',
    amount: 120,
    type: 'fresh',
    seasonality: 'summer',
    cost: 'expensive'
  ...
  },
  {
    ...
    name: 'Dried orange',
    price: 700,
    image: ['/img/products/dried-orange.jpg'],
    description: '',
    amount: 50,
    type: 'dried',
    seasonality: 'spring',
  ...
  },
  {
    ...
    price: 150,
    image: ['/img/products/frozen-blackberries.jpg'],
    description: '',
    amount: 530,
    type: 'frozen',
    seasonality: 'spring',
  ...
  {
    _id: '7',
    name: 'Fresh frozen organic mangoes',
    price: 555,
    image: ['/img/products/frozen-mango.jpg'],
    description: '',
    amount: 444,
    type: 'frozen',
    seasonality: 'fall',
  ...
  },
  {
    ...
    name: 'Dried apple',
    price: 211,
    image: ['/img/products/dried-apple.jpg'],
    description: '',
    amount: 154,
    type: 'dried',
    seasonality: 'spring',
  ...
  },
  {
    ...
    name: 'Clementines',
    price: 699,
    image: ['/img/products/clementines.png'],
    description: '',
    amount: 530,
    type: 'fresh',
    seasonality: 'winter',
  ...
  },
  {
    ...
    name: 'Pomegranate',
    price: 753,
    image: ['/img/products/pomegranate.jpg', '/img/products/pomegranate2.jpg'],
    description: '',
    amount: 530,
    type: 'fresh',
    seasonality: 'winter',
  ...
  {
  _id: '12',
  name: 'Frozen clementines',
  price: 553,
  image: ['/img/products/fr-clementines.JPG'],
  description: '',
  amount: 220,
  type: 'frozen',
  seasonality: 'winter',
...
},
{
  ...
  name: 'Frozen kiwi',
  price: 153,
  image: ['/img/products/frozen-kiwi.jpg'],
  description: '',
  amount: 120,
  type: 'frozen',
  seasonality: 'winter',
...
{
  _id: '14',
  name: 'Frozen persimmon',
  price: 833,
  image: ['/img/products/frozen-persimmon.jpg'],
  description: '',
  amount: 120,
  type: 'frozen',
  seasonality: 'winter',
...
},
{
  ...
  price: 633,
  image: ['/img/products/fr-strawberry.jpg'],
  description: '',
  amount: 120,
  type: 'frozen',
  seasonality: 'spring',
